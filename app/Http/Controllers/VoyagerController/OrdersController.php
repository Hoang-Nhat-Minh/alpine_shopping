...
class OrdersController extends VoyagerBaseController
{
    ...
    public function show(Request $request, $id)
    {
        ...
        // Custom 25/6/2024
        $order_details = OrdersDetail::where('order_id', $id)->get();
        // End Custom

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted', 'order_details'));
    }
