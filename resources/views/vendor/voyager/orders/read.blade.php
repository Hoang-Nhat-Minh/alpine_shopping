  ...
  <div class="row">
    <div class="col-md-12">
      <div class="panel panel-bordered" style="padding-bottom:5px;">
        <h2 style="padding:10px;color:black">Thông tin đơn đặt</h2>
        <!-- form start -->
        <div class="row">
    ...
    <div class="col-md-12">
      <div class="panel panel-bordered" style="padding-bottom:5px;">
        <h2 style="padding:10px;color:black">Danh sách đơn hàng</h2>
        <table class="table">
          <thead>
            <tr>
          ...
          <tbody>
            ...
            <tr style="color:black">
              <td style="font-size: larger">{{ $order_detail->product_name }}</td>
              <td><img src="{{ $order_detail->product_image }}" alt="{{ $order_detail->product_name }}" style="height:100px;width:100px;object-fit: cover;border-radius: 50%"></td>
